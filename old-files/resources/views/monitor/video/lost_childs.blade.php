...
@section('title')
    {{ config('app.name') }} | Incident Reports
@stop
@section('css')
...
$url = 'https://ifollow-cc-3f29a.firebaseio.com/.json?orderBy="isActive"&equalTo=false';
$ch = curl_init();
...
$videos = \App\Videos::with('user')->where('archive_id', '!=', '')->where('type', '=', 'lost_child')->whereIn('user_id', $user_ids)->whereIn('video_id', $video_ids)->orderBy('id', 'desc')->paginate(20);
?>
...
<!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- BEGIN PAGE TITLE-->
                       {{--  <h1 class="page-title"> {{ session('monitor_admin.0.name') }}
                                ...
                                <div class="portlet light bg-inverse">
                                    <div class="portlet-title">
                                        <div class="caption font-green-sharp">
                                            ...
                                            <span class="caption-subject">Incident Reports</span>
                                                                ...
                                                                @foreach($videos as $video)
                                                                    <tr>
                                                                        ...
                                                                        <td >{{$video->created_at}}</td>
                                                                            <td ><span class="btn green" style="padding: 5px; width: 100px;">Completed</span></td>
                                                                        <td>
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <div class="dropdown-menu pull-right">
                                                                                    ...
                                                                                    <a class="dropdown-item" onclick="add_notes('{{$video->video_id}}','{{$clear}}')">
                                                                                     ...
                                                                                     @if(session('monitor_admin.0.type') != 2)
                                                                                            @if($values!='open-incident-reports')
                                                                                                <a class="dropdown-item" onclick="delete_child('{{$video->video_id}}',this)"><i class="fa fa-trash"></i>      Delete
                                                                                                </a>
                                                                                            @endif
                                                                                      @endif
                                                                                </div>
...
<script>
 function delete_child(id,current){
bootbox.confirm("Are you sure do you want to delete this Report?", function (result) {
    if (result == true) {
          $.ajax({
        "method" : "POST",
