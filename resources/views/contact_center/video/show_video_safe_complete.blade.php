...
background-color: transparent !important;
    border: 0px solid #2797bb !important;
}
.profile {
...
<br>
        ...
        <div class="row">
            ...
            <h3 class="h3 panic-heading"> <img style="margin-top: -15px;margin-left: -10px;" height="40px" width="40px" src="{{ asset('public/images/replay-icon.png') }}"> VIDEO</h3>
           ...
           {{--  {{ dd($user) }} --}}
            ...
            <div class="col-md-5">
            <h3 class="h3 panic-heading">PROFILE</h3>
                <div class="profile">
                    <div class="image">
        ...
        <div class="row">
            <div class="col-md-7">
            <h3 class="h3 panic-heading">MESSAGES</h3>
            ...
            <div class="col-md-5">
            <h3 class="h3 panic-heading">LOCATION</h3>
                <div class="location">
