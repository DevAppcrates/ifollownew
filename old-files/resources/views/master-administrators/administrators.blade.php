      ...
      <div class="modal-content" style="margin-top: 70px">
         ...
         <div class="modal-body">
            <form class="form-group" id="edit-command-center"  novalidate="novalidate">
               ...
               <input id="number-of-admin-centers" class="form-control btn-circle" type="text" value="" placeholder="Put Number Here">
               <br>
               <label class="form-label">Number Of Users Allowd</label>
               <input id="number-of-allowed-users" class="form-control btn-circle" type="text" value="" placeholder="Put Number Here">
