                                ...
                                <div class="portlet light bg-inverse">
                                    <div class="portlet-title">
                                        <div class="caption font-green-sharp">
                                            ...
                                            <span class="caption-subject"> @if(Request::url()  == url('/monitor-hub/archive/notifications')) Archived Mass Notifications @else Mass Notifications History @endif </span>
                                                                    ...
                                                                    <td>
                                                                        <div class="">
                                                                            ...
                                                                            <div class="dropdown-menu pull-right">
                                                                                    <a href="{{ url('monitor-hub/notification/history',['notification_id'=>$notification->id]) }}" class="dropdown-item"><i class="fa fa-info-circle"></i> View Snapshot</a>
                                                                                @php
  ...
  // $(document).ready(function(){
    ...
    $('#notification-note').validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url:"{{ url('/') }}/monitor-hub/ajax/notification_note",
                type:'post',
                cache: "false",
                contentType: false,
                processData: false,
