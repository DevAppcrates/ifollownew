...
class AddColumnsTableAdmins extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
	...
	public function up() {
		...
		Schema::table('admins', function (Blueprint $table) {
			...
			$table->string('mobile_number')->nullable()->after('title');
			$table->string('other_phone')->nullable()->after('mobile_number');
	...
	public function down() {
		Schema::table('admins', function (Blueprint $table) {
			$table->dropColumn(['business_name', 'business_type', 'last_name', 'title', 'mobile_number', 'other_phone', 'website', 'mailing_st', 'mailing_city', 'mailing_state', 'mailing_zip_code']);
		});
	}
}
