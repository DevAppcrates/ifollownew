...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="lock-form" id="form" role="form" method="post">
                <div class="form-title">
                    <span class="form-title">Master Hub Login</span><br/>
                ...
                <div class="form-actions">
                    <button type="submit" id="logInButton" class="btn red btn-block uppercase">Log In</button>
                </div>

                <div class="form-actions">

                    <div class="pull-right forget-password-block">
                        <a href="{{ url('master-hub/forget/email') }}" class="forget-password">Forgot Password?</a>
                    </div>
                </div>
