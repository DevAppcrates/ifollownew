    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6" align="center" style="margin-top: -8px;">
               <h3 class="page-title"><strong> @if($video->type=='panic')PANIC ALERT Details @elseif($video->type=='lost_child') INCIDENT REPORT DETAILS  @else TIP ALERT SUMMARY @endif</strong></h3>
            </div>
...
<br>
        ...
        <div class="row">
            <div @if($video->type == 'panic') class="col-md-7" @else class="col-md-6" @endif>
                @if($video->type != 'lost_child')
                <h3 class="h3">IMAGE</h3>
                    <div class="video-section">
                        <div id="videos">
                            <div id="soon" style="text-align: center">
                                <img src="{{$video->image_path? $video->image_path:'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/No_image_3x4.svg/1280px-No_image_3x4.svg.png'}}" class="img-responsive" style="margin-top: 19px;height: 292px;object-fit: cover;width: 95% !important;">
                            </div>
                        </div>
                    </div>
                @else
                <h3 class="h3">IMAGE</h3>
                    ...
                    @if(!empty($video->lost_child))
                        <div class="p-3 location" style="padding: 10px !important;height: auto;">
                             @if(isset($video->lost_child['incident_date']))
                                <label class="form-label">Incident Date</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_child['incident_date']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_child['incident_nature']))
                                <label class="form-label">Nature Of Incident</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_child['incident_nature']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_child['incident_time']))
                                <label class="form-label">Incident Time (if known)</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_child['incident_time']??'' ?>"><br/>
                             @endif
                             @if(isset($video->lost_child['incident_invloved']))
                                <label class="form-label">Were your involved in this incident?</label>
                                <input class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->lost_child['incident_invloved']??'' ?>"><br/>
                             @endif
                            @if(isset($video->lost_child['description']))
                                <label class="form-label">Description/Notes</label>
                                <textarea rows="5" class="form-control"><?php echo $video->lost_child['description']??'' ?></textarea>
                             @endif
                             
                             
                       </div>
                       @else
                       <div class="p-3 location text-center" style="padding: 10px !important;height: 200px;text-align: center;display: flex;justify-content: center;flex-direction: column;">
                            <i class="fa fa-4x fa-info-circle"></i>
                           <h3>Incident detail not found!</h3>
                       </div>
                   @endif
                @endif
            </div>
            ...
            @if($video->type == 'lost_child')
                <div class="col-md-5">
                    ...
                    <div class="p-3 location" style="padding: 10px !important;height: 500px;">
                            ...
                            <input autocomplete="off"  class="form-control" type="text" name="name" id="l_name" value="<?php echo $user->first_name.' '.$user->last_name ?>"><br/>
                            <label class="form-label">Email</label>
                            <input autocomplete="off" class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->user->email ?>"><br/>
                            <label class="form-label">Phone</label>
                            <input autocomplete="off" class="form-control" type="text" name="name" id="l_name"  value="<?php echo $user->phone_number ?>"><br/>
                            <label class="form-label">Address</label>
                            <input autocomplete="off" class="form-control" type="text" name="name" id="l_name"  value="<?php echo $user->user_address->address_1.' '.$user->user_address->address2_m ?>"><br/>
                   </div>
                </div>
            @else
                    <div class="col-md-6">
